        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div>
            ...
            <div className="flex space-x-4 mt-6">
              <Link href="#" target="_blank" rel="noreferrer" className="text-[#F9F7F7]/70 hover:text-[#F9F7F7] transition-colors">
                <svg
              ...
              <Link href="https://www.linkedin.com/company/wazababy/" target="_blank" rel="noreferrer" className="text-[#F9F7F7]/70 hover:text-[#F9F7F7] transition-colors">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="20"
                  height="20"
              ...
              <Link href="https://github.com/waza-agency" target="_blank" rel="noreferrer" className="text-[#F9F7F7]/70 hover:text-[#F9F7F7] transition-colors">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="20"
                  height="20"
